...
<div class="card">
	<div class="card-header">
    	<h2 class="card-title"><i class="fad fa-layer-group"></i>  Data Peminjaman</h2>
    	<a href="form-pinjam.php" class="badge badge-primary"><i class="fas fa-layer-plus"></i> Tambah Peminjaman</a>
    </div>
    <div class="card-body">
